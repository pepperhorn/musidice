...
export function Overlay() {
  ...
  return (
    <div className="overlay fixed inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm">
      <h1 className="overlay-title text-5xl text-slate-800 mb-2 font-[Knewave]">RollaNote</h1>
      <p className="overlay-subtitle text-slate-500 mb-8 font-[Poppins]">Roll the dice to find your musical inspiration!</p>
      <button
        onClick={handleStart}
